...
var WETH = (_WETH = {}, _WETH[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0x45429A2255e7248e57fce99E7239aED3f84B7a53', 18, 'VVET', 'VVET'), _WETH);
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, connex) {
    try {
      ...
      var getReservesABI = find(IUniswapV2Pair.abi, {
        name: 'getReserves'
      });
...
export { ChainId, FACTORY_ADDRESS, Fetcher, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Percent, Price, Rounding, Route, Token, TokenAmount, Trade, TradeType, WETH, inputOutputComparator, tradeComparator };
//# sourceMappingURL=veswap-sdk.esm.js.map
