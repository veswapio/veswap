...
import { RadioGroup, Radio, TextField, Input } from "react-aria-components";
    ...
    <div className={clsx("tokenInput", className)}>
      <div className="tokenInput__top">
        ...
        <div className="tokenTrigger">
          <div className="tokenTrigger__icon">{TOKEN_ICONS["VET"]}</div>
          <div className="tokenTrigger__name">{tempToken}</div>
        </div>
      </div>
